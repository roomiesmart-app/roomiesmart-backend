...
import type { ResolveSpaceRequestDto } from '../../domain/dtos/space-request.dto.js';
...
export class ResolveJoinRequestUseCase {
  ...
  public async execute(requestId: string, payload: ResolveSpaceRequestDto): Promise<any> {
